...
ClaransL0::ClaransL0(const SkeletonClustererInitBundle& sb, const ExtrasBundle& eb)
  : BaseClarans(sb, eb)
{
}

void ClaransL0::put_sample_custom_in_cluster(size_t              i,
                                             size_t              k_nearest,
...
void ClaransL0::custom_remove_last(size_t k) { nearest_2_infos_margin_remove_last(k); }

void ClaransL0::update_sample_info() { basic_clarans_update_sample_info(); }
...
void ClaransL0::custom_info_test() { nearest_2_infos_margin_test(); }

void ClaransL0::put_sample_in_cluster(size_t i) { base_put_sample_in_cluster(i); }
}
