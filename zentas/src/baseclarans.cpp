...
void ClaransStatistics::set_to_zero(){
 ...
 void ClaransStatistics::increment(double d_first_nearest, double e_first_nearest, double d_second_nearest, double e_second_nearest){
...
double BaseClarans::get_delta_hat_l3(size_t k1, size_t k2, size_t j2, double d_nearest_k1, const double * const cc){
...
double BaseClarans::get_delta_E_hoeffding_l3(size_t k1, size_t k2, size_t j2, double d_nearest_k1, const double * const cc){
...
void BaseClarans::initialise_with_kmeanspp() {
...
void BaseClarans::reset_1_nearest_excluding(XNearestInfo & nearest_info, size_t k, const double * const distances){
...
double BaseClarans::get_delta_E_not_k1_l2(size_t k1, size_t k2, size_t j2, const double * const cc, bool serial){
...
void BaseClarans::update_k_to_sample_info_l2(size_t j_a, size_t j_z, const double * const dists_centers_old_k_to, const double * const cc){
  double adistance;
  size_t a1;
  size_t a2;
  double d1;
...
void BaseClarans::pll_update_sample_info_l23(size_t k, size_t j_a, size_t j_z, const double * const dists_centers_min_pr, const double * const cc){ 
...
void BaseClarans::set_nearest_12_warmstart(size_t k1, size_t j1, size_t & a1, size_t & a2, double & d1, double & d2, const double * const cc){
...
void BaseClarans::reset_sample_info_direct(size_t k, size_t j, size_t a1, size_t a2, double d1, double d2){
...
double BaseClarans::get_delta_E_k1_l12(size_t k1, size_t k2, size_t j2, double dist_k1_j2, bool serial){
...
double BaseClarans::get_delta_E_not_k1_l1(size_t k1, size_t k2, size_t j2, const double * const dists_centers_j2, bool serial){
...
void BaseClarans::reset_second_nearest_info(size_t k, size_t j, size_t k_second_nearest, double d_second_nearest, double e_second_nearest){
...
void BaseClarans::pll_update_sample_info_l1(size_t k, size_t j_a, size_t j_z, double dists_centers_min_pr_k){
  double adistance;
  for (size_t j = j_a; j < j_z; ++j){
    /* a TEST74 (grep) */
...
void BaseClarans::custom_cluster_statistics_test() {
...
void BaseClarans::set_second_nearest(size_t k_first_nearest, const double * const distances, size_t & k_second_nearest, double & d_second_nearest){
...
void BaseClarans::center_center_info_test_l1(const std::vector<XNearestInfo> & center_nearest_center){
  for (size_t k = 0; k < K; ++k){
    //size_t nearest = 0;
...
void BaseClarans::acceptance_call_l2(double * const cc, double * const dists_centers_old_k_to, double * const d_min_cc, size_t * const a_min_cc){
...
void BaseClarans::set_center_center_info_l2(double * const cc, double * const d_min_cc, size_t * const a_min_cc){
...
void BaseClarans::put_nearest_2_infos_margin_in_cluster_final(size_t k_first_nearest, size_t k_second_nearest, double d_second_nearest, double e_second_nearest){
...
void BaseClarans::put_nearest_2_infos_margin_in_cluster_post_kmeanspp(size_t k1, size_t k2, double d2, double e2) {
  put_nearest_2_infos_margin_in_cluster_final(k1, k2, d2, e2);
}


void BaseClarans::put_nearest_2_infos_margin_in_cluster(size_t i, size_t k_first_nearest, const double * const distances){
...
void BaseClarans::reset_sample_nearest_2_infos_margin(size_t k, size_t j, size_t nearest_center, const double * const distances){
  size_t k_second_nearest;
  double d_second_nearest;
...
void BaseClarans::update_sample_info_l1(const double * const dists_centers_old_k_to, const double * const dists_centers_new_k_to){
...
void BaseClarans::update_sample_info_l23(const double * const dists_centers_old_k_to, const double * const cc){
 ...
 double BaseClarans::get_delta_E_l1(size_t k1, size_t k2, size_t j2, double d_nearest_k1, bool serial){
  double delta_E = 0;
...
double BaseClarans::get_delta_E_l2(size_t k1, size_t k2, size_t j2, double d_nearest_k1, const double * const cc, bool serial){
...
void BaseClarans::update_center_center_info_l1(std::vector<XNearestInfo> & center_nearest_center, double * const dists_centers_old_k_to, double * const dists_centers_new_k_to){
