  ...
  
{
  ...
  if (initialisation_method == "from_indices_init"){
    if (sb.center_indices_init_predefined == nullptr){
      throw zentas::zentas_error("center_indices_init_predefined is nullptr, logic error in skeleton");
    }
    init::populate_from_indices_init(sb.center_indices_init_predefined, center_indices_init, K, ndata);
  }
