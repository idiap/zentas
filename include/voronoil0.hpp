...
class VoronoiL0 : public BaseClusterer<TMetric, TData> {
  ...
  private:
    ...
    virtual inline void put_sample_custom_in_cluster(size_t i, size_t a_x, const double * const distances) final override{}
    ...
    virtual inline void custom_replace_with(size_t k, size_t j, size_t k2, size_t j2) final override{}
